   ...
   bg-opacity-80 backdrop-blur-sm animate-slideup rounded-lg cursor-pointer"
    >
      <div className="relative w-full h-56 group">
        ...
        bg-gradient-to-b from-white/10 to-redBlood/60 bg-opacity-50 
         group-hover:flex ${
        ...
        <img src={song?.images?.default || song?.images?.coverart || phImage} alt="song coverart" />
      </div>
